...
void lcd_update_6(uint8_t c5,uint8_t c4,uint8_t c3, uint8_t c2, uint8_t c1, uint8_t c0){
	...
	lcd_put_bigc (char_addr[c4], 17, char_width[c4], CHAR_WIDTH, CHAR_HEIGHT);	
	lcd_put_bigc (char_addr[10], 34, char_width[10], 7, CHAR_HEIGHT);
	lcd_put_bigc (char_addr[c3], 41, char_width[c3], CHAR_WIDTH, CHAR_HEIGHT);
	lcd_put_bigc (char_addr[c2], 58, char_width[c2], CHAR_WIDTH, CHAR_HEIGHT);
	lcd_put_bigc (char_addr[10], 75, char_width[10], 7, CHAR_HEIGHT);
	lcd_put_bigc (char_addr[c1], 82, char_width[c1], CHAR_WIDTH, CHAR_HEIGHT);
	lcd_put_bigc (char_addr[c0], 99, char_width[c0], CHAR_WIDTH, CHAR_HEIGHT);
